                        ...
                        <form action="{{ route('journalist.store') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="nombre" type="text" class="form-control border-primary" id="nombre" placeholder="Ej: Elena">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="apellidos" class="form-label">Apellidos</label>
                                    <input name="apellidos" type="text" class="form-control border-info" id="apellidos" placeholder="Ej: Garro">
                                </div>
                            </div>

                            <div class="mb-3">
                                <label name="email" for="email" class="form-label">Email</label>
                                <input type="email" class="form-control border-success" id="email" placeholder="periodista@estilo.com">
                            </div>
